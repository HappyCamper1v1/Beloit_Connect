      ...
      <div className="form-field">
        ...
        <div className="form-field">
          ...
          <select name="major" defaultValue={user?.major ?? ''}>
            ...
            <option value="Critical Identity Studies">Critical Identity Studies</option>
            ...
            <option value="Quantitative Economics">Quantitative Economics</option>
            <option value="Education and Youth Studies">Education and Youth Studies</option>
            ...
            <option value="Environmental Communication and Arts">Environmental Communication and Arts</option>
            <option value="Environmental Justice and Citizenship">Environmental Justice and Citizenship</option>
            ...
            <option value="Greek and Latin Studies">Greek and Latin Studies</option>
            <option value="Health and Society">Health and Society</option>
            <option value="History">History</option>
            <option value="Interdisciplinary Studies (self-designed)">Interdisciplinary Studies (self-designed)</option>
            <option value="International Relations">International Relations</option>
            <option value="Japanese Language and Culture">Japanese Language and Culture</option>
            <option value="Journalism">Journalism</option>
            <option value="Kinesiology and Movement">Kinesiology and Movement</option>
            ...
            <option value="Physics, Engineering, and Astronomy">Physics, Engineering, and Astronomy</option>
            ...
            <option value="Engineering Programs (3-2 and 4-2)">Engineering Programs (3-2 and 4-2)</option>
            <option value="Pre-Med / Health Professions Advising">Pre-Med / Health Professions Advising</option>
            <option value="Pre-Law Preparation Advising">Pre-Law Preparation Advising</option>
          </select>


          <label htmlFor="industry">Industry</label>
          <select name="industry" defaultValue={user?.industry ?? ''}>
            <option value="Technology & Information Services">Technology & Information Services</option>
            ...
            <option value="Retail, Food & Hospitality">Retail, Food & Hospitality</option>
